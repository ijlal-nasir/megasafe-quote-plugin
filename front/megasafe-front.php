		...
		public function insert_modal_in_footer() {
			...
			<div class="modal-content">
				...
				<div class="modal-body" id="msatq_modal_body">
					...
					<p class="no-quote-in-list">Your Cart is empty</p>
					<div id="msatq_message_after_submission" class="elementdisplaynone"><h4 class="msatq_message_tagline">Your quote has been successfully submitted</h4><p class="msatq_byline">A Megasafe representative will reach out to you as soon as possible and help you fulfill your order!</p></div>
				</div>
				</div>
			</div>
			</div>';
