<?php
/**
*Plugin Name: Mega Safe Add to Quote
*Description: Create a Plugin for Add to Quote
*Version: 1.0.0
*Author: Gubloo Technologies
*License: GPL2
...
if ( !class_exists( 'msatq_MegaSafe_Main' ) ) {
	...
	class msatq_MegaSafe_Main {
      ...
      <div style="max-width: 768px; margin: auto">
        <h2 style="font-size: 40px">Qoute Requested</h2>
      </div>
    </div>
    <div style="padding: 40px 25px; max-width: 768px; margin: auto; color: #57626c">
      <div>
        <p style="font-size: 18px"> You have sent a qoute request for the following products: </p>
      ...
      $email_message_body .= '</table>
        ...
        <p style="font-size: 18px; font-weight: 600; line-height: 10px"> First Name : <span style="font-weight: 400">'.$first_name.'</span>
        </p>
        <p style="font-size: 18px; font-weight: 600; line-height: 10px"> Last Name : <span style="font-weight: 400">'.$last_name.'</span>
        </p>
        <p style="font-size: 18px; font-weight: 600; line-height: 10px"> Email : <span style="font-weight: 400; text-decoration: underline">'.$email.'</span>
        </p>
        <p style="font-size: 18px; font-weight: 600; line-height: 10px"> Phone Number * : <span style="font-weight: 400">'.$phone.'</span>
        </p>
      </div>';
			$headers[] = 'From: '.get_bloginfo();
			wp_mail( $email, 'Request a Quote', $email_message_body, $headers);
